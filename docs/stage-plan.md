...
- ✅ 完成 **10 个**真实付费订单（含 999 诊断 + 2999 工具包 + 9999 增长包任意组合）
...
[CTO 在 /admin 手动激活]
  → 创建/升级账号
  → 写入 credits（999=50 / 2999=2400 / 9999=6000）
  → 记录订单号 + 合同编号
  → 发激活邮件 + 发票 PDF
       ↓
[客户登录开始使用]
...
- 对 999/2999/9999 三档套餐提供 Stripe Price
- 国内客户继续走对公转账
...
| 收到第一笔 9999 增长包 | 同上，合同写清专项诊断和陪跑交付边界 |
